 ...
 * @method static \Storyfeed\StoryfeedManager stories(array<int|string, class-string<\Storyfeed\Stories\Story>|\Storyfeed\Stories\Verb|array<string, mixed>> $stories, bool $merge = true)
