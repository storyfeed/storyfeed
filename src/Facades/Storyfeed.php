 ...
 * @method static \Storyfeed\StoryfeedManager useCompiledStories(array{grammar: array<string, string>, aggregateGrammar: array<string, string>, icons: array<string, string>, glyphIntents?: array<string, string>, verbs: array<string, mixed>} $compiled)
