...
/**
 * @method static StoryfeedManager actorlessGrammar(array<array-key, string|\Closure|\Storyfeed\FeedHeadline> $grammar, bool $merge = true)
 * @method static string|\Closure|null actorlessTemplate(?string $type, string $verb)
 * @method static string|null actorlessTemplateKey(?string $type, string $verb)
 * @method static array<string, string|\Closure|\Storyfeed\FeedHeadline> registeredActorlessGrammar()
 * @method static \Storyfeed\Models\Activity|null publish(\Storyfeed\Stories\Story $story)
 * @method static \Storyfeed\Models\Activity|null publishNow(\Storyfeed\Stories\Story $story)
 * @method static \Storyfeed\PendingActivity route(string|\BackedEnum $name, \Illuminate\Database\Eloquent\Model|string|null $object = null)
 * @method static bool hasNamedStory(string|list<string> $name)
 * @method static string|null namedStory(string $name)
 * @method static string|null storyNameFor(?string $type, string $verb)
 * @method static array<string, string> storyNames()
 ...
 * @method static \Storyfeed\Models\Activity record(string|\Storyfeed\Contracts\FeedVerb|\BackedEnum $verb, \Illuminate\Database\Eloquent\Model|string|null $object = null, \Illuminate\Database\Eloquent\Model|string|null $actor = null, \Illuminate\Database\Eloquent\Model|string|null $target = null, \Illuminate\Database\Eloquent\Model|string|null $context = null, array<string, mixed> $data = [], \DateTimeInterface|string|null $publishedAt = null, iterable<int, \Illuminate\Database\Eloquent\Model> $objects = [], \Storyfeed\FeedThread|null $thread = null, \Illuminate\Database\Eloquent\Model|string|null $origin = null, \Illuminate\Database\Eloquent\Model|string|null $result = null, \Illuminate\Database\Eloquent\Model|string|null $instrument = null)
 ...
 * @method static void assertQueued(string|\Storyfeed\Contracts\FeedVerb|\BackedEnum|\Closure $verb, ?\Illuminate\Database\Eloquent\Model $object = null)
 * @method static void assertNotQueued(string|\Storyfeed\Contracts\FeedVerb|\BackedEnum|\Closure $verb, ?\Illuminate\Database\Eloquent\Model $object = null)
 * @method static void assertQueuedCount(int $count, string|\Storyfeed\Contracts\FeedVerb|\BackedEnum|\Closure|null $verb = null)
 ...
 * @method static \Storyfeed\StoryfeedManager grammar(array<array-key, string|\Closure|\Storyfeed\FeedHeadline> $grammar, bool $merge = true)
 * @method static \Storyfeed\StoryfeedManager icons(array<array-key, string> $icons, bool $merge = true)
 * @method static \Storyfeed\StoryfeedManager glyphIntents(array<array-key, string> $intents, bool $merge = true)
 ...
 * @method static array<string, string|\Closure|\Storyfeed\FeedHeadline> registeredGrammar()
 ...
 * @method static \Storyfeed\StoryfeedManager aggregateGrammar(array<array-key, string|\Closure|\Storyfeed\FeedHeadline> $grammar, bool $merge = true)
 * @method static \Storyfeed\StoryfeedManager axes(array<int, \Storyfeed\Grouping\Axis> $axes, bool $merge = true, ?string $before = null)
 * @method static \Storyfeed\StoryfeedManager bundleables(array<int, string> $aliases, bool $merge = true)
 ...
 * @method static \Storyfeed\StoryfeedManager useCompiledStories(array{grammar: array<string, string>, aggregateGrammar: array<string, string>, icons: array<string, string>, glyphIntents?: array<string, string>, verbs: array<string, mixed>} $compiled, list<string> $stories = [])
 * @method static void compileStories()
 * @method static array{grammar: array<string, string>, aggregateGrammar: array<string, string>, icons: array<string, string>, glyphIntents: array<string, string>, verbs: array<string, mixed>} compiledStories()
 * @method static array<int, \Storyfeed\Stories\Verb> storyDefinitions()
 * @method static array<string, string> storyActions()
 * @method static array<string, string> storyActors()
 * @method static list<\Storyfeed\Stories\Verb|\Storyfeed\Stories\PendingResource|\Storyfeed\Stories\BoundStory> registeredStories()
 * @method static bool hasStory(string $class)
 * @method static string|null boundVerb(string $class)
 * @method static string storyVerb(string $class)
 ...
 * @method static string|null glyphIntentKey(?string $type, string $verb)
 * @method static string|null aggregateTemplateKey(?string $axis, string $verb, ?string $objectType = null)
 * @method static bool declaredVerb(string $verb)
 * @method static bool isBundleable(?string $alias)
